...
void main(void)
{
	...
	while (TRUE)
	{
		...
		/*  GlobalAlloc is malloc for windows
			GPTR allocates fixed memory and initializes memory content to zero
		*/
		...
		/* create a new event for the client and assign to the overlapped structure*/
